            ...
            <div className="b-container-left">
              ...
              <div className="b-left-content">
                <p>
                  ...
                  ></i>{' '}
                  <span style={{ marginRight: 2 }}>{data.sentTo ? data.sentTo.length : 0}</span> Recipient
                </p>
                <p>
    ...
    <>
      ...
      <main className='broadcast-main'>
        <div className="main-top">
          ...
          <Link className='active' to={'/completed'}>
        ...
        <div className="main-bottom">
          <form
            ...
            <input
              ...
              type="text"
              placeholder="Search Completed Broadcast"
              name="query"
            />
